define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function (e, t, n) {
  ...
  function Ft(e, t) {
    var n = [], r = e.listSelections(), i = Lt(e.clipPos(t)), s = !At(t, i), o = e.getCursor("head"), u = qt(r, o),
      ...
      h = Math.min(c.line, i.line), p = Math.max(c.line, i.line), d = c.ch, v = i.ch, m = r[l].head.ch - d, g = v - d;
  ...
  function zn(e) {
    ...
    if (!i) {
      var u = s.inVisualBlock && t.lastSelection ? t.lastSelection.visualBlock.height : 1, a = s.changes, o = [], f = 0;
  ...
  v.Pos = function (e, t) {
    ...
    e.prototype.clear = function () {
      ...
      if (t == "local") {
        var r = Math.max(0, Math.floor(e.top / n.lineHeight)), i = Math.max(0, Math.floor(e.left / n.characterWidth)),
  ...
  var b = [{keys: "<Left>", type: "keyToKey", toKeys: "h"}, {
      ...
      type: "keyToKey",
      toKeys: "j"
    }, {keys: "<C-p>", type: "keyToKey", toKeys: "k"}, {keys: "<C-[>", type: "keyToKey", toKeys: "<Esc>"}, {
      keys: "<C-c>",
      type: "keyToKey",
      toKeys: "<Esc>"
  ...
  var ht = {
    ...
    jumpListWalk: function (e, t, n) {
      ...
      var n = e.getCursor().line, r = e.charCoords(E(n, 0), "local"), i = e.getScrollInfo().clientHeight, s = r.top,
        o = r.bottom - s;
      switch (t.position) {
        case"center":
          s = s - i / 2 + o;
  ...
  var qn = {
    colorscheme: function (e, t) {
      ...
      function u() {
        if (t.argString) {
          ...
          if (u[1]) {
            ...
            var a = u[1].indexOf("d") != -1 || u[1].indexOf("n") != -1 && 1, f = u[1].indexOf("x") != -1 && 1,
              l = u[1].indexOf("o") != -1 && 1;
      ...
      var r = t.line !== undefined ? t.line : e.firstLine(), i = t.lineEnd || t.line || e.lastLine(), s = mn(n), o = n,
        u;
  ...
  t.handler = {
    $id: "ace/keyboard/vim", drawCursor: function (e, t, n, r, s) {
      ...
      }), n(), e.renderer.$cursorLayer.drawCursor = this.drawCursor.bind(t), this.updateMacCompositionHandlers(e, !0)
    }, detach: function (e) {
      var t = e.state.cm;
      v.keyMap.vim.detach(t), t.destroy(), e.state.cm = null, e.$vimModeHandler = null, e.renderer.$cursorLayer.drawCursor = null, e.renderer.setStyle("normal-mode", !1), e.textInput.setCommandMode(!1), e.renderer.$keepTextAreaAtCursor = !0, this.updateMacCompositionHandlers(e, !1)
