define("ace/mode/red_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
    ...
    this.$rules = {
      start: [{
        ...
        regex: /#"(\^[-@/_~^"HKLM\[]|.)"/
      }, {token: "string.file", regex: /%[-\w\.\/]+/}, {token: "string.tag", regex: /</, next: "tag"}, {
        token: "string",
        regex: /"/,
        next: "string"
        ...
        regex: "comment [{]",
        next: "comment"
      }, {token: "comment", regex: /;.+$/}, {token: "paren.map-start", regex: "#\\("}, {
  ...
  var r = e("../lib/oop"), i = e("./text").Mode, s = e("./red_highlight_rules").RedHighlightRules,
    o = e("./folding/cstyle").FoldMode, u = e("./matching_brace_outdent").MatchingBraceOutdent, a = e("../range").Range,
    f = function () {
