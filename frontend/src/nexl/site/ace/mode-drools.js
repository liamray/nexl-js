define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules,
    s = e("./java_highlight_rules").JavaHighlightRules, o = e("./doc_comment_highlight_rules").DocCommentHighlightRules,
    ...
    a = "[a-zA-Z\\$_\u00a1-\uffff][\\.a-zA-Z\\d\\$_\u00a1-\uffff]*", f = function () {
      ...
      this.$rules = {
        start: [].concat(i("block.comment"), [{
          ...
          regex: "(rule)(\\s+)",
          next: "asset.name"
        }], r(), [{token: ["variable.other", "text", "text"], regex: "(" + u + ")(\\s*)(:)"}, {
          token: ["keyword", "text"],
          regex: "(query)(\\s+)",
          next: "asset.name"
          ...
          regex: "(then)(\\s*)",
          next: "java-start"
        }, {token: "paren.lparen", regex: /[\[({]/}, {token: "paren.rparen", regex: /[\])}]/}], l()),
  ...
  r.inherits(u, s), function () {
    this.foldingStartMarker = /\b(rule|declare|query|when|then)\b/, this.foldingStopMarker = /\bend\b/, this.getFoldWidgetRange = function (e, t, n) {
      ...
      if (s) {
        var u = s.index;
        if (s[1]) {
          var a = {row: n, column: r.length}, f = new o(e, a.row, a.column), l = "end", c = f.getCurrentToken();
          c.value == "when" && (l = "then");
          while (c) {
