define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function (e, t, n) {
  ...
  var r = e("../virtual_renderer").VirtualRenderer, i = e("../editor").Editor, s = e("../range").Range,
    o = e("../lib/event"), u = e("../lib/lang"), a = e("../lib/dom"), f = function (e) {
      ...
      }, n.isOpen = !1, n.isTopdown = !1, n.autoSelect = !0, n.data = [], n.setData = function (e) {
    ...
    this.setFilter = function (e) {
      ...
      e:for (var s = 0, o; o = e[s]; s++) {
        ...
        if (this.exactMatch) {
          ...
          var p;
          if ((p = u.toLowerCase().indexOf(i)) > -1) for (var d = p; d < p + i.length; d++) f |= 1 << d; else for (var v = 0; v < t.length; v++) {
