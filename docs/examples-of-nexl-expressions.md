...
| var expr1='hostsByEnv.${SPECIAL_ENV}.${INSTANCE}';<br/>var expr2='hostsByEnv.${SPECIAL_ENV}';<br/>${${expr1}:${expr2}} | depends on <b>SPECIAL_ENV</b> | This expression fixes that problem by using of default value modifier.
