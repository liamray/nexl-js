...
INTERFACES_BY_ENV = "${HOSTS.APP_SERVER_INTERFACES.${ENV}.${INSTANCE}@${HOSTS.APP_SERVER_INTERFACES.${ENV}~V}~V}";

PROD_ENVS = ["PROD.${INSTANCE}", "DRP-PROD"];

var ALL_PROD_INTERFACES_DEF = {
	"PROD": "${HOSTS.APP_SERVER_INTERFACES.${PROD_ENVS}~V-}"
};
