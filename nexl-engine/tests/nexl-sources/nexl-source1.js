...
var ALL_PROD_INTERFACES_DEF = {
	"PROD": ['${HOSTS.APP_SERVER_INTERFACES.${ENV}.${INSTANCE}~V}', '${HOSTS.APP_SERVER_INTERFACES.DRP\\-PROD}']
};

var ALL_APP_SERVER_INTERFACES = "${ALL_PROD_INTERFACES_DEF.${ENV}@${HOSTS.APP_SERVER_INTERFACES.${ENV}.${INSTANCE}~V}!}";
